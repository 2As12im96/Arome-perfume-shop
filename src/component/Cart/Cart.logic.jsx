...
import { addToCart, clearCart, decreaseCart, getTotals, justOneProduct, removeFromCart } from '../../redux/cartSlice';
...
function useCartLogic() {
    ...
    //Remove from Cart
    const removeFromCartLists = (item)=>{
