                ...
                return (
                    <span className='table_actions d-flex justify-content-between align-items-center'>
                        {adminUserName ?
                            ...
                            (<>
                                <span className='btn dispatched span' onClick={() => handleNavigateed()}>Dispatch</span>
                                <span className='btn delivered span' onClick={() => handleNavigateed()}>Deliver</span>
                                <span className='btn view span' onClick={() => handleNavigateed()}>View</span>
                            </>)
                        }
                    </span>
                );
